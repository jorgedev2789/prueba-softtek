...
var require_uuid4 = __commonJS({
  "node_modules/uuid4/index.js"(exports, module2) {
    ...
    uuid42.valid = valid;
    module2.exports = uuid42;
  }
});

// src/functions/users/application/deleteUser/handler.ts
var handler_exports = {};
...
// src/functions/users/application/deleteUser/deleteUser.ts
var DeleteUser = class {
  ...
  async exec(uuid) {
    try {
      if (!await this.repository.findOne(uuid)) {
...
// src/functions/users/application/deleteUser/handler.ts
var deleteUser = async (_event) => {
  try {
    const clientFactory = await PostgreSqlClient.getInstance().clientDB();
    const controlRepository = new UserPostgreRepository(clientFactory);
    const deleteUser2 = new DeleteUser(controlRepository);
    await deleteUser2.exec(_event.pathParameters.uuid);
...
var main = core_default(deleteUser).use(
  input_output_logger_default({
    logger: async (request) => await prepareLog(request, "Elimino un usuario "),
    awsContext: true
  })
);
