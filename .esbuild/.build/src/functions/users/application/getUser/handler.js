  ...
  "node_modules/pg-pool/index.js"(exports, module2) {
    ...
    var Pool2 = class extends EventEmitter {
      constructor(options, Client) {
        ...
        this.Client = this.options.Client || Client || require_lib7().Client;
...
// src/functions/users/application/getUser/handler.ts
var handler_exports = {};
...
// src/functions/users/application/getUser/getUser.ts
var GetUser = class {
...
var getUser = async (_event) => {
  try {
    ...
    const list = new GetUser(controlRepository);
    const list_users = await list.exec();
    return HttpResponse.ok(list_users);
  } catch (error) {
    logger.error("ERROR", error);
    return HttpResponse.error({ message: error.message, errorCode: error.statusCode });
  }
};
var main = core_default(getUser);
